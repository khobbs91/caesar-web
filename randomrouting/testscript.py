...
# from chunks.models import Chunk, ReviewMilestone, SubmitMilestone, Assignment, Semester, Milestone, Submission, File, ChunkReview
...
#         new_chunk_review = ChunkReview()
#         new_chunk_review.chunk = c
#         new_chunk_review.save()
#         print
#         print "chunk from chunk_review's perspective:", chunk_review.chunk
#         print "chunk_review from chunk's perspective:", c.chunk_review
#         print
#         # c.chunk_review = new_chunk_review
